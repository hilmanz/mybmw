...
$CONFIG['DEFAULT_MODULES_ADMIN'] = "project.php";
$CONFIG['VIEW_ON']  = 1;
$CONFIG['DINAMIC_MODULE']  = "home";
$CONFIG['DINAMIC_MODULE_ADMIN']  = "project";
...
if(preg_match("/dev./i",$_SERVER['HTTP_HOST'])){
	$DOMAIN = "http://{$_SERVER['HTTP_HOST']}/touchbase-2014/trunk/";
	$PUBLIC_HTML = "";
}else{
	$DOMAIN = "http://{$_SERVER['HTTP_HOST']}/touchbase-2014/trunk/";
	$PUBLIC_HTML = "public_html/";
}
$CONFIG['BASE_DOMAIN_PATH'] = "https://localhost/touchbase-2014/trunk/";
...
$CONFIG['ADMIN_DOMAIN'] = "{$DOMAIN}admin_html/";
...
$CONFIG['LOCAL_PUBLIC_ASSET'] = "D:/xampp/htdocs/touchbase-2014/trunk/public_html/public_assets/";
$CONFIG['PUBLIC_ASSETS_DOMAIN_PATH'] = "https://localhost/touchbase-2014/trunk/{$CONFIG['PUBLIC_ASSET']}";
$CONFIG['LOCAL_ASSET'] = "D:/xampp/htdocs/touchbase-2014/trunk/public_html/assets/";
...
$CONFIG['SESSION_NAME'] = "touchbase-2014_apps_2014";
