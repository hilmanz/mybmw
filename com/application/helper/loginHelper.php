...
class loginHelper {
	...
	function goLogin($type=1){
		...
		$data['status']=0;
		$data['msg']='To login, you must verify your email first. Please check your email and click on the link we sent you. If you have not received the email, click the resend button below.';
		$sql = "
		SELECT *
