...
--
-- Host: localhost
-- Generation Time: Feb 16, 2015 at 03:44 PM
...
CREATE TABLE IF NOT EXISTS `sys_contents_files` (
`id` int(11) NOT NULL,
...
--
-- Indexes for table `sys_contents_files`
--
ALTER TABLE `sys_contents_files`
 ADD PRIMARY KEY (`id`);
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `sys_contents_files`
--
ALTER TABLE `sys_contents_files`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
